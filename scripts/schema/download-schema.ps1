...
# Load environment variables (canonical loader)
...
if (-not $endpoint) {
		Write-Host "[FAIL] SITECORE_ENDPOINT not set in environment" -ForegroundColor Red
		exit 1
}

Write-Host "=== Downloading GraphQL Schema ===" -ForegroundColor Cyan
